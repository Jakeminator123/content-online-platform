...
.auth-main-header>a{font-size:13px;color:#476574;font-weight:600;border-bottom:1px solid transparent;transition:border-color .2s,color .2s}
.auth-main-header>a:hover{color:#087f99;border-color:currentColor}
