...
(() => {
  ...
  function render(){
    const meta=pageMeta[active];document.getElementById('breadcrumb').textContent=meta[0];document.getElementById('view-eyebrow').textContent='CONTENT ONLINE / '+meta[0];document.getElementById('view-title').textContent=meta[1];document.getElementById('view-description').textContent=meta[2];document.getElementById('toolbar').hidden=active==='overview';
  ...
  document.addEventListener('click',event=>{
    ...
    if(action==='customer')customerDetail(id);if(action==='preview')customerDetail(id,true);if(action==='publisher')publisherDetail(id);if(action==='product')productDetail(id);if(action==='connection')connectionDetail(id);
