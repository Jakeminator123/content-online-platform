...
.registry-list-heading{display:flex;align-items:center;justify-content:space-between;margin-top:24px;padding:0 0 10px;border-bottom:1px solid #dce5ea}.registry-list-heading strong,.registry-list-heading small{display:block}.registry-list-heading strong{font-size:14px}.registry-list-heading small{margin-top:4px;color:#6d818c;font-size:10px}.registry-customer{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:18px;align-items:center;padding:17px 0;border-bottom:1px solid #e3e9ed}.registry-customer-main{display:flex;align-items:flex-start;gap:13px;min-width:0}.registry-customer .body{display:grid;gap:4px;min-width:0}.registry-customer .body small{overflow-wrap:anywhere}.registry-swatch{display:flex;width:46px;height:46px;flex:none;overflow:hidden;border:1px solid #d5e1e7;border-radius:10px;background:#fff}.registry-swatch i{width:50%;height:100%}.registry-swatch img{width:100%;height:100%;object-fit:contain}.registry-demo{padding:16px 18px;border:1px solid #efc6c3;border-radius:11px;background:#fff5f4}.registry-demo>summary{cursor:pointer;color:#922f2b}.registry-demo>.registry-hint{color:#8b5a55}.registry-customer-demo{margin-top:10px;padding:16px;border:1px solid #efc6c3;border-radius:9px;background:#ffe9e7}.registry-customer-demo:last-child{border-bottom:1px solid #efc6c3}.registry-customer-demo .body>strong{color:#862b27}
.registry-editor-card{margin-top:22px;padding:22px;border:1px solid #bcd1d8;border-radius:12px;background:#f7fafb;box-shadow:0 12px 35px #17384a0c}.registry-editor-head{display:flex;align-items:flex-start;justify-content:space-between;gap:18px;padding-bottom:16px;border-bottom:1px solid #dce6ea}.registry-editor-head h3{margin:4px 0;font-size:22px}.registry-editor-head p{margin:0;color:#667d89}.registry-editor-card>.soft-box{display:grid;gap:3px;margin-top:16px}.registry-editor-card>.soft-box a{font-weight:600;overflow-wrap:anywhere}.registry-editor-card>.soft-box small{display:block}.registry-editor-form{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));align-items:start}.registry-editor-form h4,.registry-editor-form fieldset,.registry-editor-form>button,.registry-editor-form>.registry-color-row,.registry-editor-form>.registry-agent,.registry-editor-form>.registry-logo-upload,.registry-editor-form>details{grid-column:1/-1}.registry-editor-form h4{margin:0;font-size:15px}.registry-editor-form details{border:1px solid #d5e1e8;border-radius:8px;background:#fff;padding:13px 14px}.registry-editor-form summary{cursor:pointer;color:#315e5a;font-size:12px;font-weight:700}.registry-editor-form details[open] summary{margin-bottom:14px}.registry-hint{display:block;margin-top:5px;color:#70848f;font-size:10px;font-weight:400;line-height:1.45}.registry-color-row{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:14px}.registry-color{height:44px;padding:5px}.registry-logo-upload{display:grid;grid-template-columns:auto minmax(0,1fr);align-items:center;gap:14px;padding:14px;border:1px solid #d5e1e8;border-radius:8px;background:#fff}.registry-logo-preview{width:58px;height:58px}.registry-logo-preview .registry-swatch{width:58px;height:58px}.registry-logo-preview>img{width:58px;height:58px;object-fit:contain;border:1px solid #d5e1e7;border-radius:10px}.registry-agent{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:14px;background:#fff}.registry-agent legend{font-weight:700}.registry-agent>.registry-switch,.registry-agent>.registry-tools,.registry-agent>.registry-domain-note,.registry-agent>.registry-hint,.registry-agent>details{grid-column:1/-1}.registry-switch{display:flex!important;align-items:center;gap:9px}.registry-switch input{width:18px;height:18px}.registry-range{padding:3px 0;border:0}.registry-tools{display:grid;gap:4px;padding-top:6px}.registry-domain-note{margin:0;padding:12px;border-radius:8px;background:#edf5f4;color:#315e5a;font-size:11px}.registry-create{background:#fbfcfd;padding-left:14px;padding-right:14px;border-radius:10px}
...
@media(max-width:520px){.registry-overview,.registry-color-row,.registry-logo-upload{grid-template-columns:1fr}.registry-actions .button,.registry-actions a{width:100%;justify-content:center}}
