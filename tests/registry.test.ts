...
describe("Persistent registry domain", () => {
  ...
  it("emits syntactically valid client code without secret handling", () => {
    ...
    expect(registryClient).toContain("Referensdemo – inte en kund");
    ...
    expect(registryClient).toContain("Portalprofil: ");
    ...
    expect(registryClient).toContain("Referensdemo – inte en kund");
    expect(registryClient).toContain("Nya kunder skapas från den gemensamma Standard-mallen");
    expect(registryClient).toContain('name="logoFile"');
    expect(registryClient).toContain("/logo");
    expect(registryClient).toContain("Logotypen är större än 2 MB");
