...
- Do not recreate a parallel customer-frontend repository or Vercel project. The shared portal runtime in this repository is the only customer-site implementation.
