...
| Publicerad ny kund | https://fokus-psi-sable.vercel.app/o/{url-namn}/login | Egen aktiveringssida; riktiga kundkonton återstår |
...
Ny kund börjar som utkast, utan KTH:s uppgifter eller demokonton. Publiceringsbekräftelsen anger att organisationsnamnet och aktiveringssidan blir offentliga. En publicerad URL är inte en aktiverad identitet eller en dataintegration. Riktiga kundkonton, inbjudningar, tenant-medlemskap och två kundroller måste färdigställas innan verklig kunddata visas. Demoautentiseringen får aldrig återanvändas för dessa kunder.
...
- Nya portaler visar tills vidare aktiveringsinformation, inte ett påhittat fungerande login.
